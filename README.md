...
### Item Avulso no PDV
![Item Avulso](docs/screenshots/item-avulso.png)
...
- **PDV** — venda direta com leitor de código de barras, carrinho, descontos, cálculo de troco e lançamento de itens avulsos (produtos sem cadastro, serviços, consignados — sem baixa de estoque)
...
│   │       └── 006-permitir-produto-avulso.sql
│   ├── modules/
│   │   ├── configuracoes/
│   │   ├── produtos/
│   │   ├── vendas/
